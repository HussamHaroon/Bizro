...
const en = {
  ...
  hero: {
    ...
    micDenied: "Microphone unavailable — allow access, or use the simulator link below.",
    ...
    busyError: "The free AI tier is busy — try again in a minute.",
    mockNote: "Mock mode — AI output simulated (no live key)",
    parseMiss: "Bizro couldn't read an entry from that note — its reply:",
    freeTierNote: "Uses 1–2 free AI requests per recording",
...
const mixed: Copy = {
  ...
  hero: {
    ...
    demoTag: "Live demo · try it · آزمائیں",
    micIdle: "Tap to record · بولیں",
    micListening: "Listening… · سن رہا ہے…",
    micDenied:
      "Microphone unavailable — allow access, or use the simulator · مائیک اجازت دیں",
    micUnavailable:
      "This browser can't record — open the full WhatsApp chat instead · سیمیولیٹر کھولیں",
    reading: "Bizro is reading your note… · پڑھ رہا ہے",
    confirming: "Confirming… · تصدیق",
    kindWords: {
      sale: "sale",
      expense: "expense",
      udhar_given: "udhar given · ادھار",
      udhar_settlement: "payment received · وصولی",
    },
    stampPending: "AI-Parsed · Under review · زیرِ تصدیق",
    confirmBtn: "It's correct · درست ہے",
    changeBtn: "Change · بدلیں",
    sendAnother: "Send another · ایک اور",
    busyError:
      "The free AI tier is busy — try again in a minute · ایک منٹ بعد دوبارہ کوشش کریں",
    mockNote: "Mock mode — AI output simulated · نمائش",
    parseMiss: "Bizro couldn't read an entry from that note — its reply: · اس کا جواب:",
    freeTierNote: "Uses 1–2 free AI requests per recording · ہر ریکارڈنگ پر",
    chatLink: "Open the full WhatsApp chat · مکمل چیٹ",
  },
  problem: {
    ...en.problem,
...
const ur: Copy = {
  ...
  hero: {
    ...
    micIdle: "نوٹ ریکارڈ کرنے کے لیے دبائیں",
    micListening: "سن رہا ہے…",
    micDenied: "مائیک دستیاب نہیں — اجازت دیں یا نیچے سیمیولیٹر کھولیں۔",
    micUnavailable: "یہ براؤزر ریکارڈ نہیں کر سکتا — مکمل وٹس ایپ چیٹ کھولیں",
    reading: "بزرو آپ کا نوٹ پڑھ رہا ہے…",
    confirming: "تصدیق ہو رہی ہے…",
    kindWords: {
      sale: "فروخت",
      expense: "خرچ",
      udhar_given: "ادھار دیا",
      udhar_settlement: "وصولی",
    },
    stampPending: "اے آئی پارس · زیرِ تصدیق",
    confirmBtn: "درست ہے",
    changeBtn: "بدلیں",
    sendAnother: "ایک اور بھیجیں",
    busyError: "فری اے آئی ٹائر مصروف ہے — ایک منٹ بعد دوبارہ کوشش کریں۔",
    mockNote: "ماک موڈ — اے آئی آؤٹ پٹ مصنوعی ہے (لائیو کی نہیں)",
    parseMiss: "بزرو اس نوٹ سے اندراج نہیں بنا سکا — اس کا جواب:",
    freeTierNote: "ہر ریکارڈنگ پر ۱–۲ فری اے آئی درخواستیں لگتی ہیں",
    chatLink: "مکمل وٹس ایپ چیٹ کھولیں",
  },
  movie: {
