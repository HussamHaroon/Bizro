/* ReceiptCard — design.md §4.4: cream card, thin rule-line border on all four sides,
   ...
   D3-4: cream surface on the cool canvas + shadow-card (the default card ramp). */
...
export function ReceiptCard({ title, titleUr, meta, children, className = '' }: ReceiptCardProps) {
  return (
    <section className={`w-full ${className}`}>
      <div className="rounded-card border border-rule-line bg-paper-cream px-4 py-4 shadow-card sm:px-5">
